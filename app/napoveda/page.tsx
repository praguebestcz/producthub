...
const GUIDE: { icon: LucideIcon; title: string; points: string[] }[] = [
  ...
  },
  {
    ...
    points: [
      "Zvoneček v pravém horním rohu ukazuje počet nepřečtených upozornění; nová upozornění naskakují živě, bez obnovení stránky.",
  ...
  },
  {
    ...
    points: [
      ...
      "Nový komentář, odpověď nebo změna stavu od někoho jiného se u vás objeví živě, bez obnovení stránky.",
